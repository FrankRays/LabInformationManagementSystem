...
<?php
	...
	$u_status = $_POST['u_status'];				//获取用户状态
	...
	$showstatus = $u_status==1 ? '已审核' : '待审核';
	echo "用户状态：".$showstatus."<br />";
...
?>
	...
	<p>
	<!--
		<img src="../images/edit_user_continue.gif"  style="cursor:hand;" onclick="location.href='edit_personal_info_advanced.php'"/>
	-->

		<img src="../images/edit_user_continue.gif"  style="cursor:hand;" onclick="location.href='edit_personal_info_type.php'"/>
	</p>
	<br />
</div><!--表单外边框DIV_END-->
</div><!--居中DIV容器END-->
