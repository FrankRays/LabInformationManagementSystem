...
<div id="formwrapper"><!--表单外边框DIV_BEGIN-->
	<fieldset><!--表单内边框DIV_BEGIN-->
        <legend>删除课程信息</legend><!--表单内边框标题-->

<form name="form1" id="form1" method="post" action="c_del_do.php" >
...
<p align="center"><input name="Submit" id="Submit" type="submit" value="删除" />
&nbsp;&nbsp;&nbsp;&nbsp;
<input name="back" id="back" type="button" value="取消" onClick="history.back()" />
</form>
