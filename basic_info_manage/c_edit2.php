...
<form name="form1" id="form1" method="post" action="c_edit_do2.php" >
...
<p align="center">
<input name="kw" type="hidden" id="kw" value="<?php echo $kw; ?>" />
<input name="Submit" id="" type="submit" value="提交" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input name="back" id="back" type="button" value="取消" onClick="javascript:location='sc.php?kw=<?php echo urlencode($kw); ?>'" /></p>
</form>
