...
<p align="center" style="font-size:14px; color:#1E7ACE; font-weight:bold;"><?= $table_title ?>本人已提交的实验课信息登记表汇总</p>
...
<!--单元格竖合并输出BEGIN-->
  ...
  coalesce_row(document.all.id4,1,0,'null');//实验编号合并
  coalesce_row(document.all.id5,1,0,'null');//实验项目合并
