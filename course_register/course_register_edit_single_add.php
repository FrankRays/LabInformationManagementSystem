    ...
    <form action="course_register_edit_single_result.php" method="post" onSubmit="return Validator.Validate(this,3)">
        ...
        <p>实验时间——周次：
			...
			<?php
				...
				echo "<img src='../images/del_time.gif'  style='cursor:hand;' onClick='javascript:if(confirm(\"您确实要删除该记录吗？\")) location=\"course_register_edit_single_del.php?t_id=$row_tid[0]&search_condition=$search_condition&search_content=".urlencode($search_content)."\"'>";
        ...
        <p>
			...
			if( $_SESSION["u_type"] < 3)//给教师及负责人的链接
			{
				...
				echo'<input name="" type="button" value="返回" onclick="history.back();"  class="buttonSubmit" />';
			}
			else//管理员的链接
			{
