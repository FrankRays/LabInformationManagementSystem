...
<?php
	...
	$sql = sprintf ( "SELECT * FROM apply WHERE a_id='%s'",$a_id);
...
<div id="formwrapper"><!--表单外边框DIV_BEGIN-->
	<fieldset><!--表单第一个内边框DIV_BEGIN-->
        ...
        <?php
            ...
            $sql = sprintf ( "DELETE FROM apply WHERE a_id='%s'", $a_id);
		...
		<input type="button" onclick="location.href='course_register_delete_show_tea.php';" class="buttonSubmit" value="返回"/>
        <br /><br />
</div><!--表单外边框DIV_END-->
</body>
</html>