...
/**************************************specialfuckbegin*********************************************/
include("is_special_admin.php");//提供flag判断标志,看结果是否为特权者
	if( $flag == 1 )//特权鸟人的情况
	{
		echo <<<link1
              <tr> 
				<td height="20"><a href="top.php?location=cxjb" target="top" onClick="parent.right.location.href='course_register/course_register_search_special.php'">查询相关申请简表</a></td>           
			  </tr>
              <tr> 
				<td height="20"><a href="top.php?location=cxdgxxb" target="top" onClick="parent.right.location.href='data_backup/backup_apply_table_single.php'">查询单个实验课程信息表</a></td>           
			  </tr>
              <tr> 
				<td height="20"><a href="top.php?location=hzqbxxb" target="top" onClick="parent.right.location.href='data_backup/backup_apply_table_all.php'">汇总全部实验课程信息表</a></td>           
			  </tr>	
              <tr> 
				<td height="20"><a href="top.php?location=xgjxzl" target="top" onClick="parent.right.location.href='course_register/JXZL_upload/file_upload_for_special.php'">相关教学周历</a></td>           
			  </tr>
link1;
	}
/**************************************specialfuckend***********************************************/
...
module_4;
				...
				if ( in_array( "6" , $pri_content_arr) )
				{
				   echo <<<module_6
	              <tr> 
					<td height="20"><a href="top.php?location=cxjb" target="top" onClick="parent.right.location.href='course_register/course_register_search.php'">实验室相关申请简表</a></td>
				  </tr>
module_6;
				}
				/*---------------6、查询登记表END--------------------*/	
...
module_22;
				...
				/*---------------7、上传教学周历BEGIN--------------------*/
				if ( in_array( "7" , $pri_content_arr) )//针对负责人填写登记表（作为老师功能，才会有上传教学周历）
				{
